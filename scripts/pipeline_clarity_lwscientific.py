...
def run_clarity_pipeline():
    print("🚀 Starting Clarity Pageviews Pipeline for lwscientific")
    api_key = fetch_secret("lwscientific_prod_clarity_api_key")
    clarity_project_id = fetch_secret("lwscientific_clarity_project_id")
